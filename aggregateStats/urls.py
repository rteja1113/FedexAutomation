...
from .views import home, actual_agg, actual_agg_view, preload_agg, preload_agg_view, add_daily_service

urlpatterns = [
    path('', home, name="fedexAutomation-home"),
    path('upload-driver-schedule/', add_daily_service, name="upload-schedule"),
    path('actual-aggregation/', actual_agg_view, name="act-agg-start-end"),
    path('preload-aggregation/', preload_agg_view, name="preload-agg-start-end"),
